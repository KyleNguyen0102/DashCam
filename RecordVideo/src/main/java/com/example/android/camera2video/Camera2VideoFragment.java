...
public class Camera2VideoFragment extends Fragment
    ...
    interface FragmentCallback {
        void onClickButton(boolean isRecording);
    }
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        mMediaRecorder.setMaxFileSize(MAX_SIZE);
        int rotation = activity.getWindowManager().getDefaultDisplay().getRotation();
    ...
    public void onInfo(MediaRecorder mr, int what, int extra) {
        if (DEBUG) {
            Log.d(TAG, "onInfo() called with: mr = [" + mr + "], what = [" + what + "], extra = [" + extra + "]");
        }
        switch (what) {
            case MEDIA_RECORDER_INFO_MAX_FILESIZE_REACHED:
//                API 26+ support setNextOutputFile
//                mMediaRecorder.setNextOutputFile(mNextVideoAbsolutePath);
                break;
            default:
                break;
        }
